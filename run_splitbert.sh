...
CUDA_VISIBLE_DEVICES=0,1,2,3 srun --unbuffered torchrun --master_port 29503 --nproc_per_node=4 main.py --device 0,1,2,3 --model_type SplitBERT --version split_latest_2class --batch_size 4
