...
CUDA_VISIBLE_DEVICES=0,1,2,3 srun --unbuffered torchrun --master_port 29502 --nproc_per_node=4 main.py --device 0,1,2,3 --model_type SplitBERT --version shared_multigpu_fixed --batch_size 4
