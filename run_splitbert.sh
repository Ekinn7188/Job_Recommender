...
CUDA_VISIBLE_DEVICES=4,5,6,7 srun --unbuffered torchrun --master_port 29503 --nproc_per_node=4 main.py --device 4,5,6,7 --model_type SplitBERT --version split_latest --batch_size 4
